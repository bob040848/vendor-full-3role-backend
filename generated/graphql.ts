...
import { User, Vendor, Shop, Product, ProductDelivery, ProductDeliveredHistory, ProductReturnHistory, ProductRemaining, ProductStock, DeliveryPerson, ShopOrder, VendorRequest, DailySalesReport, AdminApproval, Payment } from '@prisma/client';
...
export type GQL_AdminApproval = {
  ...
  vendor_request: GQL_VendorRequest;
...
export type GQL_CreateVendorRequestInput = {
  address?: InputMaybe<Scalars['String']['input']>;
  description?: InputMaybe<Scalars['String']['input']>;
  email: Scalars['String']['input'];
  name: Scalars['String']['input'];
...
export type GQL_Mutation = {
  __typename?: 'Mutation';
  approveVendorRequest: GQL_VendorRequest;
  ...
  createVendorRequest: GQL_VendorRequest;
...
export type GQL_MutationApproveVendorRequestArgs = {
...
export type GQL_MutationCreateVendorRequestArgs = {
  input: GQL_CreateVendorRequestInput;
};
...
export type GQL_Query = {
  ...
  vendorRequest?: Maybe<GQL_VendorRequest>;
  vendorRequests: Array<GQL_VendorRequest>;
...
export type GQL_QueryVendorRequestArgs = {
  id: Scalars['String']['input'];
};


export type GQL_QueryVendorRequestsArgs = {
  status?: InputMaybe<GQL_RequestStatus>;
};
...
export type GQL_User = {
  ...
  shop_orders: Array<GQL_ShopOrder>;
  updated_at: Scalars['DateTime']['output'];
  vendor_requests: Array<GQL_VendorRequest>;
};
...
export type GQL_ResolversTypes = ResolversObject<{
  ...
  CreateVendorRequestInput: GQL_CreateVendorRequestInput;
  ...
  ShopOrderItem: ResolverTypeWrapper<Omit<GQL_ShopOrderItem, 'product' | 'shop_order'> & { product: GQL_ResolversTypes['Product'], shop_order: GQL_ResolversTypes['ShopOrder'] }>;
  ...
  VendorRequest: ResolverTypeWrapper<VendorRequest>;
}>;
...
export type GQL_ResolversParentTypes = ResolversObject<{
  ...
  Shop: Shop;
  ShopOrder: ShopOrder;
  ShopOrderItem: Omit<GQL_ShopOrderItem, 'product' | 'shop_order'> & { product: GQL_ResolversParentTypes['Product'], shop_order: GQL_ResolversParentTypes['ShopOrder'] };
  ShopOrderItemInput: GQL_ShopOrderItemInput;
...
export type GQL_AdminApprovalResolvers<ContextType = GraphQLContext, ParentType extends GQL_ResolversParentTypes['AdminApproval'] = GQL_ResolversParentTypes['AdminApproval']> = ResolversObject<{
  ...
  vendor_request?: Resolver<GQL_ResolversTypes['VendorRequest'], ParentType, ContextType>;
  vendor_request_id?: Resolver<GQL_ResolversTypes['String'], ParentType, ContextType>;
...
export type GQL_MutationResolvers<ContextType = GraphQLContext, ParentType extends GQL_ResolversParentTypes['Mutation'] = GQL_ResolversParentTypes['Mutation']> = ResolversObject<{
  approveVendorRequest?: Resolver<GQL_ResolversTypes['VendorRequest'], ParentType, ContextType, RequireFields<GQL_MutationApproveVendorRequestArgs, 'approved' | 'id'>>;
  ...
  confirmDelivery?: Resolver<GQL_ResolversTypes['ProductDeliveredHistory'], ParentType, ContextType, RequireFields<GQL_MutationConfirmDeliveryArgs, 'delivery_person_id' | 'product_id' | 'shop_id' | 'total_price' | 'transaction_type'>>;
  ...
  createVendorRequest?: Resolver<GQL_ResolversTypes['VendorRequest'], ParentType, ContextType, RequireFields<GQL_MutationCreateVendorRequestArgs, 'input'>>;
...
export type GQL_QueryResolvers<ContextType = GraphQLContext, ParentType extends GQL_ResolversParentTypes['Query'] = GQL_ResolversParentTypes['Query']> = ResolversObject<{
  ...
  vendorRequest?: Resolver<Maybe<GQL_ResolversTypes['VendorRequest']>, ParentType, ContextType, RequireFields<GQL_QueryVendorRequestArgs, 'id'>>;
  vendorRequests?: Resolver<Array<GQL_ResolversTypes['VendorRequest']>, ParentType, ContextType, Partial<GQL_QueryVendorRequestsArgs>>;
...
export type GQL_UserResolvers<ContextType = GraphQLContext, ParentType extends GQL_ResolversParentTypes['User'] = GQL_ResolversParentTypes['User']> = ResolversObject<{
  ...
  shop_orders?: Resolver<Array<GQL_ResolversTypes['ShopOrder']>, ParentType, ContextType>;
  updated_at?: Resolver<GQL_ResolversTypes['DateTime'], ParentType, ContextType>;
  vendor_requests?: Resolver<Array<GQL_ResolversTypes['VendorRequest']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type GQL_VendorRequestResolvers<ContextType = GraphQLContext, ParentType extends GQL_ResolversParentTypes['VendorRequest'] = GQL_ResolversParentTypes['VendorRequest']> = ResolversObject<{
  address?: Resolver<Maybe<GQL_ResolversTypes['String']>, ParentType, ContextType>;
  ...
  id?: Resolver<GQL_ResolversTypes['String'], ParentType, ContextType>;
  name?: Resolver<GQL_ResolversTypes['String'], ParentType, ContextType>;
  phone?: Resolver<Maybe<GQL_ResolversTypes['String']>, ParentType, ContextType>;
  reviewed_at?: Resolver<Maybe<GQL_ResolversTypes['DateTime']>, ParentType, ContextType>;
  status?: Resolver<GQL_ResolversTypes['RequestStatus'], ParentType, ContextType>;
  updated_at?: Resolver<GQL_ResolversTypes['DateTime'], ParentType, ContextType>;
  user?: Resolver<GQL_ResolversTypes['User'], ParentType, ContextType>;
  user_id?: Resolver<GQL_ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GQL_Resolvers<ContextType = GraphQLContext> = ResolversObject<{
  ...
  VendorRequest?: GQL_VendorRequestResolvers<ContextType>;
}>;
